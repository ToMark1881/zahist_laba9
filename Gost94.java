...
public class Gost94 {
    ...
    public void execute(String text) {
        ...
        System.out.println("Sending message to B = " + text + " and digital signature (w` = " + w1 + ", s = " + s + ")");
        ...
        System.out.println("If w’ = u: " + w1 + " = " + u + ", then receiver B thinks that received message T’ = T and it delivered by А.");
        System.out.println("\n");
    }
